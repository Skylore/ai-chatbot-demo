...
tarteaucitron.services.force24 = {
  ...
  js: function() {
    ...
    window.Force24Object = "f24",
      window["f24"] = window["f24"] || function() {
...
tarteaucitron.services.criteoonetag = {
  ...
  js: function() {
    "use strict";
    if (tarteaucitron.user.criteoonetagAccount === undefined)
      return;
...
tarteaucitron.services.artetv = {
  ...
  js: function() {
    ...
    tarteaucitron.fallback(["artetv_player"], function(x) {
      var frame_title = tarteaucitron.getElemAttr(x, "title") || "Arte.tv iframe", video_json = tarteaucitron.getElemAttr(x, "json"), video_width = tarteaucitron.getElemAttr(x, "width"), video_height = tarteaucitron.getElemAttr(x, "height"), video_frame, video_allowfullscreen = tarteaucitron.getElemAttr(x, "allowfullscreen");
...
tarteaucitron.services.dailymotion = {
  ...
  js: function() {
    ...
    tarteaucitron.fallback(["dailymotion_player"], function(x) {
      var frame_title = tarteaucitron.getElemAttr(x, "title") || "Dailymotion iframe", video_id = tarteaucitron.getElemAttr(x, "videoID"), video_width = tarteaucitron.getElemAttr(x, "width"), frame_width = "width=", video_height = tarteaucitron.getElemAttr(x, "height"), frame_height = "height=", video_frame, embed_type = tarteaucitron.getElemAttr(x, "embedType"), allowfullscreen = tarteaucitron.getElemAttr(x, "allowfullscreen"), showinfo = tarteaucitron.getElemAttr(x, "showinfo"), autoplay = tarteaucitron.getElemAttr(x, "autoplay"), api = tarteaucitron.getElemAttr(x, "api"), params = "info=" + showinfo + "&autoPlay=" + autoplay + "&api=" + api;
  ...
  js: function() {
    ...
    tarteaucitron.fallback(["soundcloud_player"], function(x) {
      ...
      if (autoplay && autoplay.length > 0)
        qs += "&auto_play=" + autoplay;
      if (showComments && showComments.length > 0)
        qs += "&show_comments=" + showComments;
      if (hideRelated && hideRelated.length > 0)
        qs += "&hide_related=" + hideRelated;
      if (showUser && showUser.length > 0)
        qs += "&show_user=" + showUser;
...
tarteaucitron.services.spotify = {
  ...
  js: function() {
    ...
    tarteaucitron.fallback(["spotify_player"], function(x) {
      var frame_title = tarteaucitron.getElemAttr(x, "title") || "Spotify iframe", spotify_id = tarteaucitron.getElemAttr(x, "spotifyID"), spotify_width = tarteaucitron.getElemAttr(x, "width"), frame_width = "width=", spotify_height = tarteaucitron.getElemAttr(x, "height"), frame_height = "height=", spotify_frame;
...
tarteaucitron.services.xiti = {
  ...
  js: function() {
    ...
    var Xt_param = "s=" + tarteaucitron.user.xitiId + "&p=", Xt_r, Xt_h, Xt_i, Xt_s, div = document.createElement("div");
    try {
...
tarteaucitron.services.youtube = {
  ...
  js: function() {
    ...
    tarteaucitron.fallback(["youtube_player"], function(x) {
      var frame_title = tarteaucitron.getElemAttr(x, "title") || "Youtube iframe", video_id = tarteaucitron.getElemAttr(x, "videoID"), srcdoc = tarteaucitron.getElemAttr(x, "srcdoc"), loading = tarteaucitron.getElemAttr(x, "loading"), video_width = tarteaucitron.getElemAttr(x, "width"), frame_width = "width=", video_height = tarteaucitron.getElemAttr(x, "height"), frame_height = "height=", video_frame, allowfullscreen = tarteaucitron.getElemAttr(x, "allowfullscreen"), start = tarteaucitron.getElemAttr(x, "start"), end = tarteaucitron.getElemAttr(x, "end"), attrs = ["theme", "rel", "controls", "showinfo", "autoplay", "mute", "start", "end", "loop", "enablejsapi"], params = attrs.filter(function(a) {
        return tarteaucitron.getElemAttr(x, a) !== null
      }).map(function(a) {
        return a + "=" + tarteaucitron.getElemAttr(x, a)
      }).join("&");
...
tarteaucitron.services.issuu = {
  ...
  js: function() {
    ...
    tarteaucitron.fallback(["issuu_player"], function(x) {
      var frame_title = tarteaucitron.getElemAttr(x, "title") || "Issuu iframe", issuu_id = tarteaucitron.getElemAttr(x, "issuuID"), issuu_width = tarteaucitron.getElemAttr(x, "width"), frame_width = "width=", issuu_height = tarteaucitron.getElemAttr(x, "height"), frame_height = "height=", issuu_frame, issuu_embed;
...
tarteaucitron.services.archive = {
  ...
  js: function() {
    ...
    tarteaucitron.fallback(["archive_player"], function(x) {
      var video_id = tarteaucitron.getElemAttr(x, "data-videoID"), video_width = tarteaucitron.getElemAttr(x, "data-width"), frame_width = "width=", video_height = tarteaucitron.getElemAttr(x, "data-height"), frame_height = "height=", video_frame;
      if (video_id === undefined) {
        return ""
      }
      if (video_width !== undefined) {
...
tarteaucitron.services.gallica = {
  ...
  js: function() {
    ...
    tarteaucitron.fallback(["gallica_player"], function(x) {
      var src = tarteaucitron.getElemAttr(x, "data-src"), style = tarteaucitron.getElemAttr(x, "data-style"), frame;
      if (src === undefined) {
        return ""
      }
